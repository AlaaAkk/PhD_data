...
d0=pd.read_csv( "MoS2_VS.dat" ,sep='\s+', header=0) # total MoS2 8x8 Pristine
...
plt.plot(d1['Energy']-VBM+0.2, up, 'r-', label='MoS2@Au')
plt.plot(d1['Energy']-VBM+0.2, -dn, 'b-', label='MoS2@Au')
